  // $(function() {
    ...
    update_todo: function(newtodo){
      ...
      render: function(){
        return(
          React.createElement("div", {id: "todolist"}, 
            ...
            React.createElement(DoList, {todos: this.state.todos, update_todo: this.update_todo})
          )
        );
      }
  			...
  			var tlist =  this.props.todos.map(function(todo){
  				return(
  					React.createElement("li", null, 
  						React.createElement(ToDo, {key: todo._id, todo: todo, update_todo: that.props.update_todo})
  					)
  				);
  			});
  			return (
  	...
  	var ToDo = React.createClass({displayName: "ToDo",
  		...
  		componentWillUpdate: function(nextProps, nextState){
  			if(this.props.state != this.props.nextState){
  				this.props.update_todo(this.props.todo);
  			}	
  		},
  			...
  			if(this.state.iseditable){
  				return(
  					React.createElement("div", {className: "todo-wrapper center-60"}, 
  						React.createElement("textarea", {className: "text", defaultValue: textval}), 
